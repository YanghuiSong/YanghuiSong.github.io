...
- 只保留有代表性的奖学金、校级以上荣誉或重要学术/竞赛荣誉，避免主页变成完整获奖清单。
- `url` 优先使用学校、教育主管部门、会议或赛事官方页面。
- 同一时间、同一官方公示中的两个紧密相关称号，可以合并为一条，避免视觉碎片化。
- 中文名称尽量遵循官方原文；英文名称以准确、自然为优先，不必逐字翻译。
